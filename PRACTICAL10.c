...
int main() {
    ...
    do {
        ...
        switch(choice) {
            ...
            case 1:
                total += 150;
                printf("Burger added. Current total: ₹%.2f\n", total);
                break;
            case 2:
                total += 200;
                printf("Pizza added. Current total: ₹%.2f\n", total);
                break;
            case 3:
                total += 120;
                printf("Pasta added. Current total: ₹%.2f\n", total);
                break;
            case 4:
                total += 100;
                printf("Sandwich added. Current total: ₹%.2f\n", total);
                break;
            case 5:
                total += 80;
                printf("French Fries added. Current total: ₹%.2f\n", total);
                break;
            default:
